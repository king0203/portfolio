  ...
  return (
    ...
    z-10 lg:px-16 md:px-12 sm:px-8">
...

      {
        ...
        className="bg-dark/90 dark:bg-light/75 backdrop-blur-sm py-32 rounded-2xl
      min-w-[70vw] z-20 flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
